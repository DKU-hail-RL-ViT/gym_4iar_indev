...
def policy_evaluate(env,  curr_best_mcts_player, old_mcts_player, n_games=30):  # total 30 games
    ...
    """
    curr_mcts_player = curr_best_mcts_player  # training Agent
...
if __name__ == '__main__':
    ...
    # TODO 그니까 여기에는 이전 버전의 best모델의 policy_value_net을 deepcopy를 하든 가져와야하는거고
    policy_value_net_old = copy.deepcopy(policy_value_net)
    # TODO 이거는 현재 training 중인
