...
def get_shaded_color(base_palette, index, total):
    """명도 조절로 색상 밝기 변경"""
    palette = sns.color_palette(base_palette, total)
...
plt.title("Elo Rating by model / cat(nmcts or resource) / quantiles / eps")
plt.legend(
    loc='upper center',
