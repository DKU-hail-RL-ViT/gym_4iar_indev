...
from gym_4iar.qrdqn_utils import calculate_quantile_huber_loss, disable_gradients, evaluate_quantile_at_action, update_params
...
class QRDQNAgent(BaseAgent):
    def __init__(self, env,  num_steps=5*(10**7), num_actions=36,
                 batch_size=128, N=32, kappa=1.0, lr=5e-5, memory_size=10**6,
        ...
        super(QRDQNAgent, self).__init__(
            ...
            use_per, eval_interval, num_eval_steps, max_episode_steps, grad_cliping, cuda)
